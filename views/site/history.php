...
<div class="site-history">
  ...
  <ul>
    ...
    <li class="text-smooth">
      ...
      <ul>
        <li class="text-smooth">
          フォントを更新しました。
          <ul>
            <li class="text-smooth">にゃしぃフォント改二: Version 2.084</li>
            <li class="text-smooth">にゃしぃフレンズ: Version 2.084</li>
          </ul>
        </li>
      </ul>
    </li>
    <li class="text-smooth">
      ...
      <ul>
        <li class="text-smooth">
          フォントを更新しました。
          <ul>
            <li class="text-smooth">にゃしぃフォント改二: Version 2.08</li>
            <li class="text-smooth">にゃしぃフレンズ: Version 2.08</li>
          </ul>
        </li>
      </ul>
    </li>
    <li class="text-smooth">
      2021-04-20
      <ul>
        <li class="text-smooth">みかちゃん-Pを削除しました。</li>
        <li class="text-smooth">フォント「M+ 1m」を追加しました。</li>
        <li class="text-smooth">「M+ 1p」を指定時に「通信欄への等幅フォントの利用」が利用できるようになりました（M+ 1mが利用されます）。</li>
      </ul>
    </li>
    <li class="text-smooth">
      2021-02-06
      <ul>
        <li class="text-smooth">
          フォントを更新しました。
          <ul>
            <li class="text-smooth">にゃしぃフォント改二: Version 2.0710</li>
            <li class="text-smooth">にゃしぃフレンズ: Version 2.0710</li>
          </ul>
        </li>
      </ul>
    </li>
    ...
    <li class="text-smooth">
      ...
      <ul>
        <li class="text-smooth">
          利用可能フォントを追加しました。
          <ul>
            <li class="text-smooth">IPA明朝</li>
            <li class="text-smooth">IPAゴシック</li>
          </ul>
        </li>
        <li class="text-smooth">
    ...
    <li class="text-smooth">
      ...
      <ul>
        ...
        <li class="text-smooth">
          フォントを更新しました。
          <ul>
            <li class="text-smooth">にゃしぃフォント改二: Version 2.077</li>
            <li class="text-smooth">にゃしぃフレンズ: Version 2.077</li>
          </ul>
        </li>
      </ul>
    </li>
    ...
    <li class="text-smooth">
      2019-07-02
      <ul>
        <li class="text-smooth">入力欄の大きさやヒントの文字色などを調整しました。</li>
      </ul>
    </li>
    <li class="text-smooth">
      2019-07-01
      <ul>
        <li class="text-smooth">入力欄を整理しました。</li>
        <li class="text-smooth">
